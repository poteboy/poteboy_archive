            ...
            <div className={style.all}>
                <div className={style.content}>
                    ...
                    <h3 style={{textAlign: 'center'}}>プライバシーポリシー</h3>
                        ...
                        <h2>広告</h2>
                        <p>本アプリでは広告配信ツールとしてAdMob(Google社提供)を使用しております。AdMobのプライバシーポリシーは<a target="_blank" href="https://support.google.com/admob/answer/6128543?hl=en">こちら</a>をご確認ください。</p>
                        <h2>お問い合わせ先</h2>
                        <p>何かご不明点がございましたら<a target="_blank" href="https://twitter.com/_poteboy_">@_poteboy_</a>までご連絡ください。</p>
                    </div>
                </div>
            </div>
        </Blog>
